...
instance Print Expr where
  prt i e = case e of
    ...
    EUnify expr1 expr2 expr3 -> prPrec i 0 (concatD [doc (showString "unify"), prt 0 expr1, doc (showString "with"), prt 0 expr2, doc (showString "in"), prt 0 expr3])
    ELambda argdefs typedef expr -> prPrec i 6 (concatD [doc (showString "("), doc (showString "\\"), prt 0 argdefs, doc (showString ":"), prt 0 typedef, doc (showString "->"), prt 0 expr, doc (showString ")")])
    EInferredLambda argdefs expr -> prPrec i 6 (concatD [doc (showString "("), doc (showString "\\"), prt 0 argdefs, doc (showString "->"), prt 0 expr, doc (showString ")")])
    ...
    ERange n1 n2 -> prPrec i 6 (concatD [doc (showString "["), prt 0 n1, doc (showString ".."), prt 0 n2, doc (showString "]")])
