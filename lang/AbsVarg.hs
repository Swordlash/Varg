...
data MemberDef
    = EmptyMemberDefinition UIdent DerivationDef
    | MemberDefinition UIdent DerivationDef [ClassField]
  deriving (Eq, Ord, Show, Read)

data DerivationDef = Derives UIdent | NotDerives
  deriving (Eq, Ord, Show, Read)
