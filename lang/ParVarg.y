...
%token
  ...
  'class' { PT _ (TS _ 30) }
  'derives' { PT _ (TS _ 31) }
  'deriving' { PT _ (TS _ 32) }
  'else' { PT _ (TS _ 33) }
  'false' { PT _ (TS _ 34) }
  'final' { PT _ (TS _ 35) }
  ...
  'has' { PT _ (TS _ 37) }
  'if' { PT _ (TS _ 38) }
  'implement' { PT _ (TS _ 39) }
  'implementing' { PT _ (TS _ 40) }
  'import' { PT _ (TS _ 41) }
  'in' { PT _ (TS _ 42) }
  'interface' { PT _ (TS _ 43) }
  'internal' { PT _ (TS _ 44) }
  'let' { PT _ (TS _ 45) }
  'match' { PT _ (TS _ 46) }
  'matching' { PT _ (TS _ 47) }
  'mod' { PT _ (TS _ 48) }
  'module' { PT _ (TS _ 49) }
  'native' { PT _ (TS _ 50) }
  'not' { PT _ (TS _ 51) }
